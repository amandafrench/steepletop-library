...
<form <?php echo tag_attributes($formAttributes); ?>>
    <div id="search-keywords" class="field">
        <?php echo $this->formLabel('keyword-search', __('Exact match')); ?>
        <div class="inputs">
        <?php
            echo $this->formText(
                'search',
    ...
    <div id="search-narrow-by-fields" class="field">
        <label><?php echo __('Narrow by ...'); ?></label>
        <div class="inputs">
        <?php
...
-->
    <div class="field">
        <?php echo $this->formLabel('collection-search', __('Collection')); ?>
        <div class="inputs">
        <?php
            echo $this->formSelect(
                'collection',
    ...
    <div class="field">
        <?php echo $this->formLabel('item-type-search', __('Type')); ?>
        <div class="inputs">
        <?php
            echo $this->formSelect(
                'type',
...
<!--    <?php if(is_allowed('Users', 'browse')): ?>
    <div class="field">
    <?php
        echo $this->formLabel('user-search', __('User'));?>
        <div class="inputs">
        <?php
            echo $this->formSelect(
                'user',
...
-->
    ...
    <div>
        <?php if (!isset($buttonText)) $buttonText = __('Search for Books'); ?>
