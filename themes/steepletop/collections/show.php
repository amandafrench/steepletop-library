...
<div id="secondary">
    <div id="collection-items">
        ...
        <?php foreach (loop('items', $collectionItems) as $item): ?>
            ...
            <p><?php echo link_to_item(metadata($item, array('Dublin Core', 'Title')), array('class'=>'permalink'), 'show', $item); ?></p>
    ...
    <h3 class="view-items-link"><?php echo link_to_items_browse(__('View %s', metadata('collection', array('Dublin Core', 'Title'))), array('collection' => $collectionId)); ?></h3>
    <?php endif; ?>
</div>
<?php echo foot(); ?>
