...
<h2><?php echo link_to_items_browse(__('%s', metadata($collection, array('Dublin Core', 'Title'))), array('collection' => $collection->id)); ?></h2>
...
<!--            <p class="view-items-link"><?php echo link_to_items_browse(__('View %s', metadata($collection, array('Dublin Core', 'Title'))), array('collection' => $collection->id)); ?></p> -->
